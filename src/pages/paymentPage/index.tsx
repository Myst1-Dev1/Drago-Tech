...
export default function PaymentPage() {
    ...
    function handleOpenProcessToPayment(e?:FormEvent) {
        e?.preventDefault();

        setProcessToPayment(!processToPayment)
    }
                ...
                <div className={`col-md-6 mb-5 ${styles.formContainer}`}>
                    <form className='d-flex flex-column gap-3'>
                        ...
                        <div className='m-auto'>
                            <Button onClick={handleOpenProcessToPayment}>Prosseguir</Button>
                        </div>
                    </form>

                    {processToPayment && (
                        <div className={`d-flex gap-3 mt-5 ${styles.paymentMethodBox}`}>
