    ...
    return (
        <>
            ...
            <div className="container py-5 d-flex flex-column justify-content-center align-items-center gap-3">      
                <img className="w-50 d-block d-sm-none" src="/images/404Img.webp" alt="imagem de 404" />
                <img className="w-25 d-none d-sm-block" src="/images/404Img.webp" alt="imagem de 404" />
