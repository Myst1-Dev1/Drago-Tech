...
export function MostSaledProducts({ onHandleAddToCart }: NewProductsProps) {
    const { products } = useContext(ProductsContext);

    const productData = products.slice(6, 12);

    return (
        <div className={`mb-5 container ${styles.mostSaledProducts}`}>
