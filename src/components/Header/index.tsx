    ...
    return (
        <>
            <div className={`text-light w-100 ${styles.header}`}>
                <div className='row py-5 justify-content-between align-items-center container m-auto'>
                    <div className='d-flex gap-3 align-items-center col-md-4'>
                        <h3>
                    ...
                    <div className={`d-flex gap-4 col-md-4 ${styles.headerIcons}`}>
